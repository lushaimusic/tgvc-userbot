...
url['readme_heroku'] = (
    "https://github.com/ZauTeKm/tg-vc-userbot#deploy-to-heroku"
)
url['heroku'] = (
    "https://heroku.com/deploy?template="
    "https://github.com/ZauTeKm/tg-vc-userbot/tree/dev"
)
url['replit'] = "https://replit.com/@ZauteKm/generate-pyrogram-session-string"
...
url['repo'] = "https://github.com/ZauTeKm/tg-vc-userbot"
notes['repo'] = f"""{emoji.LABEL} **Repository** (/notes #repo):

{emoji.ROBOT} [Telegram Voice Chat Userbot (tg-vc-userbot)]({url['repo']})"""

url['tmbh'] = (
    "https://heroku.com/deploy?template="
    "https://github.com/ZauTeKm/tgmusicbot"
)
notes['musicbot'] = (
    f"""{emoji.ROBOT} **Telegram Music Bot** (/notes #musicbot):
__bot for downloading music from YouTube/SoundCloud/Mixcloud__

**Repository**: [GitHub](https://github.com/ZauTeKm/tgmusicbot)
